...
**Raw Data**
- [WITS data in a cvs format](https://github.com/ecn310/course-project-tariffs/blob/main/Data%20files/WITS-Country-Timeseries-Data.csv): data directly from WITS in csv format.
- [TariffsTimeseries](https://github.com/ecn310/course-project-tariffs/blob/main/Data%20files/TariffsTimeseries.dta): data already imported to Stata in dta format.

**Do Files**
- [TariffsTimeseries](https://github.com/ecn310/course-project-tariffs/blob/main/Do%20files/Tarrifs%20Timeseries.do): do file to import the cvs into Stata, save it as an dta file and sumarize the data.
