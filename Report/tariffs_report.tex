...
The World Integrated Trade Solution (WITS) is a trade software provided by the World Bank that consists of trade and tariff data. The International Centre for Tax and Development Government Revenue Dataset (ICTD-GRD) provides detailed tax and government revenue data for nearly all countries. Our sample includes eleven developed countries 2001-2020: Australia, Blegium, Canada, France, Ireland, Israel, South Korea, New Zealand, Norway, Switzerland, and the United States, amounting to 220 country-year observations. We classify these countries as "developed" based on their consistently high GDP per capita. 


We obtained four trade indicators to create our key variables from WITS: Exports of goods and services (\% of GDP) measures the value of all exported goods and services as a percentage of GDP; Imports of goods and services (\% of GDP) measures the value of all imported goods and services as a percentage of GDP, GDP (current USD) represents the gross domestic product of each country in current US dollars; and Import Value (Current USD) captures the total value of imports in current US dollars. 
