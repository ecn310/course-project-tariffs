...
Write a short description of each  data set. Use subsections as demonstrated below if you have more than one data set. Replace this paragraph with a very short overview of your data, e.g. "We plan to use firm-level data from Compustat."

\subsection{Data Set 1 [replace with a descriptive title of your dataset]}
\begin{itemize}
